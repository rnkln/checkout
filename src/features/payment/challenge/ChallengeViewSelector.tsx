...
import { Challenge, challengeTypes } from '../client/payment_types';

export type ChallengeViewSelectorProps = {
  strategy?: 'auto' | 'manual';
  challenges?: Array<Challenge>;
  children: (challenge: Challenge | undefined) => ReactNode;
};
    ...
    return (
      ...
      >
        ...
        <Flex flexDirection="column" gap={2}>
          {[...challenges]
            .sort((a, b) => getChallengePriority(a) - getChallengePriority(b))
            .map((c) => (
              <button
                key={c.type}
                type="button"
