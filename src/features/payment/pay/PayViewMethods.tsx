...
import type { Amount, Method } from '../client/payment_types'
import { CardForm } from '../../../lib/card/CardForm'
import type { CardFormValues } from '../../../lib/card/use_card_values'
...
export const PayViewMethods = ({
	...
	const methodsSorted: Method[] = useMemo(
		() =>
		...
		case 'card':
			return (
				<CardForm
					...
					busy={props.busy}
					onSubmit={(values) =>
						props.onComplete({ method: 'card', values })
					}
				/>
			)
		default:
